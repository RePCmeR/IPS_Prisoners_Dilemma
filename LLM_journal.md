...
С помощью Gemini 3 Flash получил дизайн для окна обучения, который отдал DeapSeek вместе с текстом, который должен быть в обучении.

---

С помощью DeapSeek и библиотеки Axelrod заполнил presets 25 разными стратегиями, добавил их все в уровни.

---

С помощью DeapSeek поменял все alert и prompts на модальные окна + сказал поиграться с их дизайном.

---

С помощью DeapSeek исправил баги с отсутствием отображения вероятностей на ребрах + эта механика не работала, поэтому попросил найти ошибку и исправить ее.

Пытался вытащить из DeapSeek вараинт, как можно еще обозначать вероятности на ребрах, чтобы было легко считывать визуально, но не получилось.

---

С помощью DeapSeek узнал варианты, с помощью которых можно задеплоить web приложение, опроповал Netlify (не работал), CloudFlare Pages (требовал VPN для запуска), Render (требовал VPN для запуска), остановился на GitHub Pages.

---

Попросил у DeapSeek добавить комментарии к коду и подредактировать/упростить/оптимизировать его

---

Попросил DeapSeek красиво и аккуратно оформить Readme, скормив ему файлы проекта, тз, дав требования и описание моего проекта, примеры других проектов
